...
**Пожизненный доступ.** Флаг `billing_exempt` на клиенте — стоящее обещание бесплатного доступа:
такого клиента автоприостановка не трогает никогда, что бы ни говорила его подписка. Все клиенты,
существовавшие на момент наката миграции `0008`, освобождены; новые — нет. Флаг не меняет `enabled`:
выключенного вручную клиента он не включает. Управляется тумблером в карточке клиента.
